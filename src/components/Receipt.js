...
export default class Receive extends React.Component {
  ...
  componentDidMount() {
    ...
    if (
      this.props.receipt &&
      this.props.receipt.params &&
      this.props.receipt.params.callback
    ) {
      console.log(
        'Redirecting to ',
        this.props.receipt.params.callback,
      ...
      setTimeout(() => {
        window.location =
          this.props.receipt.params.callback +
          '?receipt=' +
          encodeURI(JSON.stringify(returnObject));
      }, 2500);
    }
  }
  render() {
          ...
          <div className="row" style={{ cursor: 'pointer', width: '100%' }}>
            ...
            >
              <i
                ...
                style={{ color: '#39e917', fontSize: 180, opacity: 0.7 }}
              />
            </div>
          </div>
