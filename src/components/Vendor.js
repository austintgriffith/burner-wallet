        ...
        let productIsActive = (
          <button className="btn btn-large w-100"
            onClick={()=>{
              ...
              tx(contracts.DenDai.addProduct(prod.id,prod.name,prod.cost,!prod.isAvailable),240000,0,0,(result)=>{
      ...
      <div className="main-card card w-100">
        ...
        <div className="content bridge row">
          ...
          <button className="btn btn-large w-100" style={{backgroundColor:mainStyle.mainColor,whiteSpace:"nowrap"}} onClick={()=>{
            ...
            tx(contracts.DenDai.addProduct(nextId,web3.utils.utf8ToHex(this.state.newProductName),web3.utils.toWei(""+this.state.newProductAmount, 'ether'),true),240000,0,0,(result)=>{
