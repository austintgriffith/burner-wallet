        ...
        <div>
          ...
          <RecentTransactions
            ...
            transactionsByAddress={
              ERC20TOKEN
                ? this.props.fullTransactionsByAddress
            ...
            recentTxs={
              ERC20TOKEN ? this.props.fullRecentTxs : this.props.recentTxs
            }
          />
        </div>
      );
        ...
        <div>
          ...
          >
            <div className="content row">
              ...
              <div className="form-group w-100">
                <label htmlFor="amount_input">
                  {i18n.t('request_funds.item_message')}
                </label>
                <input
                  type="text"
                  className="form-control"
              ...
              <button
                type="submit"
                style={{ backgroundColor: this.props.mainStyle.mainColor }}
