...
class App extends Component {
  ...
  render() {
    ...
    if (
      window.location.hostname.indexOf("xdai") >= 0 ||
    ...
    if (web3) {
      ...
      if (this.state.scanning) {
        ...
        if (this.state.claimed) {
          ...
          let qrValue =
            url + "/" + this.state.sendLink + ";" + this.state.sendKey;
          ...
          if (this.state.balance <= 0) {
            connectedDisplay.push(<div style={alertStyle}>No Funds.</div>);
            setTimeout(() => {
              window.location = "/";
            }, 1000);
          }
              ...
              <div style={{ padding: 10, opacity: uiopacity }}>
                ...
                <Button
                  ...
                  onClick={() => {
                    ...
                    tx(
                      contracts.Links.send(randomHash, sig.signature),
                      140000,
                      false,
            ...
            >
              ...
              <div style={{ padding: 10, opacity: uiopacity }}>
                ...
                <div style={{ padding: 10 }}>
                  <Blockie config={{ size: 20 }} address={this.state.sendTo} />
                </div>
                <Button
                  size="2"
                  color={"#00FF00"}
          ...
          let sentToDisplay = (
            <InputGroup style={{ margin: "40px 0px 40px 0px" }}>
              <InputGroupAddon addonType="prepend">
                <InputGroupText>Send to address:</InputGroupText>
              </InputGroupAddon>
              <Input
                type="text"
                name="sendToInput"
                value={this.state.sendToInput}
                onChange={this.handleInput.bind(this)}
              />
            </InputGroup>
          );
          ...
          if (this.state.metaAccount) {
            ...
            copyDisplay = (
              <div>
                <CopyToClipboard
                  text={this.state.metaAccount.privateKey}
                  onCopy={() => {
          ...
          connectedDisplay.push(
            ...
            >
              ...
              <Container>
                ...
                >
                  <div style={{ cursor: "pointer" }}>
                    ...
                    <div style={{ fontSize: 10 }}>{qrDisplay}</div>
                  </div>
                </CopyToClipboard>
              </Container>
              <hr />
              <Container style={{ marginTop: "20px" }}>
                ...
                <Row>{sentToDisplay}</Row>
                <Row>{bridgeButton}</Row>
                <hr />
                <Row>{copyDisplay}</Row>
                <Row>{burnDisplay}</Row>
              </Container>
              ...
              <Container>
                <div style={{ marginTop: 100, marginBottom: 100 }}>
                  <Button color="#FF8C00" size="2" onClick={this.toggle}>
                    Help
                  </Button>
                  <Modal
                  ...
                  >
                    <ModalHeader toggle={this.toggle}>How To Use:</ModalHeader>
                    <ModalBody>
                      <h2>Steps:</h2>
                      <p>1.</p>
                      <p>2.</p>
                    ...
                    <ModalFooter>
                      <Button color="#00FF00" onClick={this.toggle}>
                        Okay
                      </Button>
                    </ModalFooter>
                  </Modal>
            ...
            this.setState({ contracts: contracts }, async () => {
              ...
              if (this.state.claimId && this.state.claimKey) {
                if (this.state.balance > 0.005) {
                  ...
                  let hashOfDestination = this.state.web3.utils.sha3(
                    this.state.account
                  );
                  ...
                  axios
                    .post(CLAIM_RELAY + "/link", postData, {
                      headers: {
